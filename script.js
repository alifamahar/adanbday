document.getElementById('name-form').addEventListener('submit', function (e) {
    ...
    const nameInput = document.getElementById('name-input').value.trim(); // Mengambil nilai input dan menghapus spasi ekstra
    const errorMessage = document.getElementById('error-message');
    const successMessage = document.getElementById('success-message');
    const submitButton = document.getElementById('submit-btn'); // Tombol untuk mengganti teks

    // Cek apakah nama yang dimasukkan benar
    if (nameInput.toLowerCase() === 'farhan hadi ramadhan') {
